...
import { Modem4GPlansSection } from "@/components/modem4g-plans-section"
...
import { Modem4GRouterSection } from "@/components/modem4g-router-section"
...
import { Modem4GSmartphoneSection } from "@/components/modem4g-smartphone-section"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <Modem4GRouterSection />
        <Modem4GDataManagementSection />
        <Modem4GFAQSection />
        <Modem4GSmartphoneSection />
