          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-white font-semibold px-8" style={{ backgroundColor: '#FF9900' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de saber mais sobre AWS Cloud na Vivo Empresas" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  Solicitar Contato
                  <ArrowRight className="ml-2 h-5 w-5" />
                </a>
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de agendar uma consultoria gratuita sobre AWS Cloud" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
