...
import { Smartphone, Wifi, Truck, Shield, Headphones, CreditCard } from "lucide-react"
import { movelAparelhoConfig } from "@/data/movel-aparelho-data"

export function MovelAparelhoBenefitsSection() {
  const { benefits } = movelAparelhoConfig
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
            Por que escolher nossos Combos Móveis?
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
            Benefícios exclusivos para sua empresa com tecnologia de ponta e suporte especializado
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl p-6 sm:p-8 lg:p-12 text-white text-center">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4">
            Economia Garantida para sua Empresa
          </h3>
          <p className="text-base sm:text-lg lg:text-xl text-purple-100 mb-6 max-w-3xl mx-auto">
            Com nossos combos móveis, você economiza até 30% comparado à compra separada do aparelho e plano.
            Além disso, oferecemos condições especiais para empresas com múltiplas linhas.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">30%</div>
              <div className="text-purple-100 text-sm sm:text-base">de economia</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">24x</div>
              <div className="text-purple-100 text-sm sm:text-base">sem juros</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">100%</div>
              <div className="text-purple-100 text-sm sm:text-base">frete grátis</div>
            </div>
          </div>
        </div>
      </div>
