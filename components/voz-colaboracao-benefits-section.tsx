...
import { Phone, Users, Shield, BarChart, Settings, Headphones } from "lucide-react"
import { vozColaboracaoConfig } from "@/data/voz-colaboracao-data"

export function VozColaboracaoBenefitsSection() {
  const { benefits } = vozColaboracaoConfig
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
            Por que escolher nossas soluções de Voz e Colaboração?
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
            Tecnologia de ponta e suporte especializado para otimizar a comunicação da sua empresa
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl p-6 sm:p-8 lg:p-12 text-white text-center">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4">
            Comunicação Empresarial de Nova Geração
          </h3>
          <p className="text-base sm:text-lg lg:text-xl text-purple-100 mb-6 max-w-3xl mx-auto">
            Nossas soluções de voz e colaboração são desenvolvidas para empresas que buscam eficiência, 
            qualidade e inovação em suas comunicações internas e externas.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">99.9%</div>
              <div className="text-purple-100 text-sm sm:text-base">disponibilidade</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-purple-100 text-sm sm:text-base">suporte técnico</div>
            </div>
          </div>
        </div>
      </div>
