...
import { Map, Wrench, Shield, Handshake, Volume2, ArrowRight, Lock, Star } from "lucide-react"
import { sipTrunkingConfig } from "@/data/sip-trunking-data"

export function SipTrunkingBenefitsSection() {
  const { benefits } = sipTrunkingConfig
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">
            SIP Trunking: benefícios e diferenciais para sua empresa
          </h2>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-3xl p-6 sm:p-8 lg:p-12 text-white text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-purple-100 mb-6 max-w-3xl mx-auto">
            Nossa solução SIP Trunking utiliza a mais avançada tecnologia em telefonia IP, 
