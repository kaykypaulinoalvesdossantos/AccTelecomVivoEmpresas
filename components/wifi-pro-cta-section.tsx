...
import { Wifi, Phone, Mail, MessageCircle } from "lucide-react"

export function WifiProCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              Transforme seu Wi-Fi
              <span className="block text-white/90">em uma máquina de vendas</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Junte-se a milhares de empresas que já descobriram o poder do Wi-Fi Pro 
              para aumentar vendas, fidelizar clientes e gerar receita adicional.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-white/30 bg-transparent text-white hover:bg-white/10 px-12 py-6 text-xl font-semibold rounded-xl transition-all duration-300 cursor-pointer"
            >
          ...
          <div className="mt-16 pt-8 border-t border-white/20">
            ...
            <p className="text-white/70 text-sm mt-2">
              *Condições especiais para novos clientes. Consulte termos e condições.
            </p>
          </div>
        </div>
      </div>
