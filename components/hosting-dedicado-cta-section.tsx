...
import { Server, Phone, Mail, MessageCircle } from "lucide-react"

export function HostingDedicadoCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              Transforme sua infraestrutura
              <span className="block text-white/90">com Hosting Dedicado</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Junte-se a centenas de empresas que já descobriram o poder do Hosting Dedicado 
              para otimizar custos, aumentar segurança e focar no core business.
            </p>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-white/20">
            ...
            <p className="text-white/70 text-sm mt-2">
              *Instalação e configuração gratuita. Consulte termos e condições.
            </p>
          </div>
        </div>
      </div>
