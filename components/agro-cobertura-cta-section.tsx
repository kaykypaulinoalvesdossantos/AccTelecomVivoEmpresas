...
export function AgroCoberturaCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              ...
              <span className="block text-white/90">com conectividade inteligente</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Junte-se a centenas de produtores que já descobriram o poder da Agro Cobertura 
