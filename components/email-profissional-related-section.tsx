...
import { Cloud, Mail, Globe, Search } from "lucide-react"

export function EmailProfissionalRelatedSection() {
  const solutions = [
    {
      icon: Cloud,
    ...
    {
      icon: Mail,
      title: "Crie um e-mail profissional para empresa",
      description: "E-mails corporativos com seu domínio próprio para maior credibilidade",
      buttonText: "Saiba mais",
      buttonVariant: "outline" as const
    },
    {
      icon: Globe,
      title: "Registre já o seu domínio por R$39,90",
      description: "Registre seu domínio e tenha presença digital profissional",
      buttonText: "Saiba mais",
      buttonVariant: "outline" as const
    },
    {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Ferramenta para criar um site profissional para
            <span className="block text-white/90">empresas</span>
          </h2>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Complete sua presença digital com nossas soluções integradas 
            de hospedagem, e-mail profissional e criação de sites.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-white/90 mb-6">
              Contrate seu e-mail profissional agora e dê o primeiro passo para 
              uma comunicação corporativa profissional.
            </p>
