...
export default function ConstrucaoSiteCtaSection() {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/90 leading-relaxed max-w-3xl mx-auto">
                Comece hoje mesmo com nosso construtor de sites. 
                Templates prontos, domínio grátis e suporte técnico 24/7.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
              ...
              <p className="text-white/90 text-sm">
                Teste nosso construtor sem compromisso. Se não ficar satisfeito, 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center space-y-2">
              ...
              <div className="text-white font-semibold">Templates Gratuitos</div>
              <div className="text-white/80 text-sm">Mais de 500 opções</div>
            </div>
            ...
            <div className="text-center space-y-2">
              ...
              <div className="text-white font-semibold">Domínio Grátis</div>
              <div className="text-white/80 text-sm">1 ano incluído</div>
            </div>
