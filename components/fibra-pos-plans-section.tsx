            ...
            >
              ...
              <CardContent className="pt-0">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <a
                    href={`https://wa.me/5511989150001?text=Olá! Gostaria de contratar o plano ${plan.name} (Fibra ${plan.internet} + ${plan.mobile})`}
                    target="_blank"
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href={`https://wa.me/5511989150001?text=Olá! Gostaria de tirar dúvidas sobre o plano ${plan.name}`} target="_blank" rel="noopener noreferrer">
