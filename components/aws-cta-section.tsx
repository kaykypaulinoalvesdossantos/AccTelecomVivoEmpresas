        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
              <a href="https://wa.me/5511989150001?text=Olá! Gostaria de calcular os custos do AWS" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                Calcular Custos
              </a>
            </Button>
          </div>
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
              <a href="https://wa.me/5511989150001?text=Olá! Gostaria de falar via WhatsApp sobre AWS" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                WhatsApp
              </a>
            </Button>
            <Button variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
            ...
            <Button variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
              <a href="mailto:sac@acctelecom.com.br?subject=Consulta sobre AWS Cloud" className="cursor-pointer">
                Email
              </a>
            </Button>
          </div>
