...
import { Cloud, ArrowRight, Server, Shield, Globe } from "lucide-react"

export function IBMHeroSection() {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <span className="block" style={{ background: 'linear-gradient(90deg, #FFB84C 0%, #FFFFFF 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                  Serviços de nuvem completa da IBM
                </span>
              </h1>
              <p className="text-xl leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                Redução de custos, aumento da produtividade, segurança e muito mais!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Infraestrutura Escalável</p>
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Recursos sob demanda</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>FIPS 140-2 Nível 4</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  <p className="font-semibold">Plataformas Abertas</p>
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Linguagens de mercado</p>
                </div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-white font-semibold px-8 cursor-pointer" style={{ backgroundColor: '#FF9900' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de saber mais sobre IBM Cloud na Vivo Empresas" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  Solicitar Contato
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent cursor-pointer" asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de agendar uma consultoria gratuita sobre IBM Cloud" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:max-w-none">
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">IBM Cloud</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                ...
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">Data Centers</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
