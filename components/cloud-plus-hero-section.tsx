...
import { Cloud, ArrowRight, Shield, Server, Database } from "lucide-react"

export function CloudPlusHeroSection() {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                Mantenha seus dados seguros e longe de invasões.
                Soluções de nuvem personalizadas com infraestrutura dedicada e gerenciamento simplificado.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Proteção avançada</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  <p className="font-semibold">Infraestrutura Dedicada</p>
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Recursos exclusivos</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  <p className="font-semibold">Gerenciamento Simplificado</p>
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Controle total</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-white font-semibold px-8" style={{ backgroundColor: '#FF9900' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de saber mais sobre Cloud Plus na Vivo Empresas" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  Saiba Mais
                  <ArrowRight className="ml-2 h-5 w-5" />
                </a>
              </Button>
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent" asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de agendar uma consultoria gratuita sobre Cloud Plus" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:max-w-none">
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">Cloud Plus</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                ...
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">Data Center TIER III</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  <Database className="h-8 w-8 text-white mx-auto mb-2" />
                  <h3 className="font-semibold text-white">Gerenciamento</h3>
                </div>
              </div>
            </div>
