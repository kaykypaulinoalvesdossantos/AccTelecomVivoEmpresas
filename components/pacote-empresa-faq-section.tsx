...
export function PacoteEmpresaFAQSection() {
  const { faq, contact } = pacoteEmpresaConfig
          ...
          <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
            <CardContent className="p-6 sm:p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Nossa equipe de especialistas está pronta para ajudar você a escolher o melhor pacote empresarial.
              </p>
