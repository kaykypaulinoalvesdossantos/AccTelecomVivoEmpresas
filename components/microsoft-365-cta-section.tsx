...
export function Microsoft365CTASection() {
  const solutions = [
    {
      title: "SD-WAN",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <Badge className="mb-4 text-white border-white/30 hover:bg-white/30" style={{ backgroundColor: 'rgba(102, 0, 153, 0.2)' }}>
            ...
            Confira mais soluções da ACC Telecom para empresas
          </Badge>
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Soluções complementares para sua empresa
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Descubra outras soluções da ACC Telecom que podem potencializar ainda mais seus resultados com Microsoft 365
          </p>
        </div>
