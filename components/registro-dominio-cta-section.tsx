...
export function RegistroDominioCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              ...
              <span className="block text-white/90">agora mesmo</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Dê o primeiro passo para uma presença digital profissional. 
              Registre seu domínio com a Vivo e aumente a credibilidade da sua empresa.
            </p>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-white/20">
            ...
            <p className="text-white/70 text-sm mt-2">
              *Registro válido por 1 ano. Renovação automática. Consulte termos e condições.
            </p>
          </div>
        </div>
      </div>
