...
export function SipTrunkingCTASection() {
  const { contact } = sipTrunkingConfig
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 lg:mb-6">
            Pronto para implementar SIP Trunking na sua empresa?
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-purple-100 max-w-3xl mx-auto">
            Fale com nossos especialistas e implemente a solução SIP Trunking na sua empresa hoje mesmo
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-purple-100">Sistema ativo e funcionando</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20">
          <div className="text-center space-y-4">
            ...
            <div className="text-xs sm:text-sm lg:text-base text-purple-100 space-y-2 max-w-4xl mx-auto">
              <p>
                <strong>Implementação:</strong> Análise técnica, configuração e testes incluídos em todos os planos.
              </p>
              <p>
                <strong>Suporte:</strong> Atendimento técnico especializado 24/7 com SLA diferenciado.
              </p>
              <p>
                <strong>Garantia:</strong> Disponibilidade de 99.9% com monitoramento em tempo real.
              </p>
            </div>
          </div>
        </div>
