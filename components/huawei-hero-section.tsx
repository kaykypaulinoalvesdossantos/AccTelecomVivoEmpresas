...
export function HuaweiHeroSection() {
  return (
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                Soluções de nuvem completas e seguras para sua empresa.
                Infraestrutura ágil, segurança certificada e custo-benefício excepcional.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">Infraestrutura Ágil</p>
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Deploy rápido</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Proteção total</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Pagamento local</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-white font-semibold px-8 cursor-pointer" style={{ backgroundColor: '#FF9900' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de saber mais sobre Huawei Cloud na Vivo Empresas" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  Saiba Mais
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 bg-transparent cursor-pointer" asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de agendar uma consultoria gratuita sobre Huawei Cloud" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:max-w-none">
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">Huawei Cloud</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                ...
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  ...
                  <h3 className="font-semibold text-white">Infraestrutura</h3>
                </div>
                <div className="rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
                  <Zap className="h-8 w-8 text-white mx-auto mb-2" />
                  <h3 className="font-semibold text-white">Alto Desempenho</h3>
                </div>
              </div>
            </div>
