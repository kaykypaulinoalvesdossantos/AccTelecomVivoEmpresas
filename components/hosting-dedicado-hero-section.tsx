...
export function HostingDedicadoHeroSection() {
  return (
          ...
          <div className="text-white space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                Hosting dedicado da
                <span className="block text-white/90">Vivo</span>
              </h1>
              
              <p className="text-xl lg:text-2xl text-white/90 max-w-2xl leading-relaxed">
                Contrate o serviço de hospedagem da Vivo e otimize seus custos
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                ...
                <p className="text-sm text-white/80">Infraestrutura</p>
              </div>
              <div className="text-center">
                <Database className="w-8 h-8 text-white mx-auto mb-2" />
                <p className="text-sm text-white/80">Servidores</p>
              </div>
              <div className="text-center">
                ...
                <div className="bg-gradient-to-r from-[#660099] to-[#EB3C7D] p-6 text-white">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/90 text-sm">Infraestrutura dedicada</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gray-50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-[#660099]">99.9%</div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    <h4 className="font-semibold text-gray-900 mb-4">Status dos Servidores</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Servidor Web</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-3 text-sm">
                        ...
                        <span className="text-gray-600">Backup automático realizado</span>
                        <span className="text-xs text-gray-400">2h</span>
                      </div>
                      <div className="flex items-center space-x-3 text-sm">
                        <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                        <span className="text-gray-600">Atualização de segurança</span>
                        <span className="text-xs text-gray-400">4h</span>
                      </div>
                      <div className="flex items-center space-x-3 text-sm">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-gray-600">Sistema otimizado</span>
