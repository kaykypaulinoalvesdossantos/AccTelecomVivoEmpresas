          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300" style={{ backgroundColor: '#FF9900' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Ainda tenho dúvidas sobre Microsoft 365" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
              ...
              <Button variant="outline" className="border-2 px-8 py-3 rounded-lg font-semibold transition-all duration-300" style={{ borderColor: '#660099', color: '#660099' }} asChild>
                <a href="https://wa.me/5511989150001?text=Olá! Gostaria de solicitar contato sobre Microsoft 365" target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  Solicitar Contato
                </a>
              </Button>
            </div>
