...
import { ArrowRight, Phone, Wifi } from "lucide-react"
import { fibraRepetidorConfig } from "@/data/fibra-repetidor-data"

export function FibraRepetidorCTASection() {
  const { finalCta, contact } = fibraRepetidorConfig
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`https://wa.me/5511989150001?text=Olá! Quero finalizar meu pedido de Fibra com Repetidor`}
              target="_blank"
            ...
            <a
              href={`https://wa.me/5511989150001?text=Olá! Preciso falar com um especialista sobre Wi-Fi`}
              target="_blank"
              rel="noopener noreferrer"
