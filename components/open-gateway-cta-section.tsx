...
import { Code, Phone, Mail, MessageCircle } from "lucide-react"

export function OpenGatewayCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              ...
              <span className="block text-white/90">com APIs inteligentes</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Junte-se a centenas de desenvolvedores que já descobriram o poder do Open Gateway 
              para criar soluções inovadoras e acelerar o crescimento dos negócios.
            </p>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-white/20">
            <p className="text-white/80 text-lg">
              <strong>Documentação completa</strong> - APIs bem documentadas com exemplos práticos
            </p>
            <p className="text-white/70 text-sm mt-2">
              *Suporte técnico especializado. Consulte termos e condições.
            </p>
          </div>
        </div>
      </div>
