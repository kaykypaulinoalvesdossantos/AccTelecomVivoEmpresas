...
import { Shield, Clock, Network, Globe } from "lucide-react"
import { redeCorporativaConfig } from "@/data/rede-corporativa-data"

export function RedeCorporativaHeroSection() {
  const { hero, contact } = redeCorporativaConfig
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white/10 px-6 py-3 md:px-8 md:py-4 text-base md:text-lg bg-transparent"
              >
