...
export function ColocationCtaSection() {
  return (
        ...
        <div className="text-center text-white">
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">
              ...
              <span className="block text-white/90">com Colocation</span>
            </h2>
            
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Junte-se a centenas de empresas que já descobriram a segurança e confiabilidade 
              do Colocation da Vivo para seus servidores e equipamentos.
            </p>
          </div>
